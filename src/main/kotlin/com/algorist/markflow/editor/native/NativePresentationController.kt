 ...
 * host resources, #148 derived renderer presentation and #149 sanitized raw-HTML presentation are
 * composed behind independent owners. This class has no browser/JCEF dependency and no source write
 * path. Plans are accepted only for the exact current source/config identity.
 */
internal class NativePresentationController(
    ...
    private val refreshOnCreate: Boolean = true,
) : Disposable {
